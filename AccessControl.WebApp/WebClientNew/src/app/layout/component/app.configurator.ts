...
@Component({
    ...
    template: `
        <div class="flex flex-col gap-4">
            <div>
                <span class="text-sm text-muted-color font-semibold">{{'topbar.color' | translate}}</span>
            ...
            <div>
                <span class="text-sm text-muted-color font-semibold">{{'topbar.backgroundcolor' | translate}}</span>
                <div class="pt-2 flex gap-2 flex-wrap justify-start">
